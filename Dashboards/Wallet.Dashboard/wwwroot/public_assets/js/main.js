...
$(function () {
  ...
  $('.floated-np-btn, .floated-np-w .np-close').on('click', function () {
    $('.floated-np-w').toggleClass('active');
    return false;
  });

  $('.message-input').on('keypress', function (e) {
    if (e.which == 13) {
      $('.np-messages').append('<div class="message self"><div class="message-content">' + $(this).val() + '</div></div>');
      $(this).val('');
      var $messages_w = $('.floated-np-w .np-messages');
  ...
  $('.floated-np-w .np-messages').perfectScrollbar();
  ...
  function add_full_chat_message($input) {
    $('.np-content').append('<div class="np-message self"><div class="np-message-content-w"><div class="np-message-content">' + $input.val() + '</div></div><div class="np-message-date">1:23pm</div><div class="np-message-avatar"><img alt="" src="img/avatar1.jpg"></div></div>');
    $input.val('');
    var $messages_w = $('.np-content-w');
    $messages_w.scrollTop($messages_w[0].scrollHeight);
  }

  $('.np-btn a').on('click', function () {
    add_full_chat_message($('.np-input input'));
    return false;
  });
  $('.np-input input').on('keypress', function (e) {
    if (e.which == 13) {
